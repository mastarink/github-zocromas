...
#  define STD_CMD_ARGS MAS_PASS_OPTS_DECLARE unsigned nesting, mas_cmd_t * this_table, mas_cmd_t * this_command, mas_rcontrol_t * prcontrol, STD_CMD_ARGS_BASE

#  define STD_CMD_PASS_BASE question, args, level
#  define STD_CMD_PASS MAS_PASS_OPTS_PASS nesting, this_table, this_command, prcontrol, STD_CMD_PASS_BASE
