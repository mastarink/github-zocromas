...
call MasIncludeComment2("duf_action_table", "duf_actions_table_std")
  ...
  call MasIncludeComment2("duf_config_puz_types", "duf_config_puz_flags_combo_t; duf_config_puz_flags_t; duf_config_puz_flags_enum_t;")
  ...
  call MasIncludeComment2("duf_hook_types", "duf_str_cb2_t; duf_sel_cb2_t; duf_anyhook_t; duf_action_table_t;")
  call MasIncludeComment2("duf_item_types", "duf_items_t")
  ...
  call MasIncludeComment2("duf_nodetype", "duf_nodetype_name")
  ...
  call MasIncludeComment2("duf_pathinfo_depth", "duf_pi_calc_depth; duf_pi_is_good_depth; duf_pi_check_depth; duf_pi_godown;")
  ...
  call MasIncludeComment2("duf_pdi_pi_ref", "duf_pdi_levinfo; duf_pdi_*depth;")
  ...
  call MasIncludeComment2("duf_sccbh_eval_all", "duf_sccbh_eval_all")
  call MasIncludeComment2("duf_sccbh_eval_leaf", "duf_sccbh_eval_db_leaf_str_cb; duf_sccbh_eval_db_leaf_fd_str_cb;")
  call MasIncludeComment2("duf_sccbh_row", "duf_sccbh_row_get_*; sccbh_rows_eval")
  call MasIncludeComment2("duf_sccbh_shortcuts", "H_SCCB; H_PDI; H_* ...")
  call MasIncludeComment2("duf_sccbh_structs", "duf_sccb_handle_s (from duf_sccbh_types: duf_sccb_handle_t; duf_sccbh_fun_t; duf_rsccbh_fun_t)")
  call MasIncludeComment2("duf_sccbh_types", "duf_sccb_handle_t; duf_sccbh_fun_t; duf_rsccbh_fun_t")
  call MasIncludeComment2("duf_sccb_row", "datarow_*")
  call MasIncludeComment2("duf_sccb_row_field_defs", "DUF_*FIELD2*")
  call MasIncludeComment2("duf_sccb_scanstage", "duf_scanstage_name; duf_scanstage_scanner;")
  call MasIncludeComment2("duf_sccb_structs", "duf_scan_callbacks_s; duf_sccb_data_row_s; duf_scanner_fun_s;")
  call MasIncludeComment2("duf_sccb_types", "duf_scan_callbacks_t; duf_sccb_data_row_t; duf_scanner_fun_t;")
  ...
  call MasIncludeComment2("duf_sql_field", "__duf_sql_str_by_name2 for DUF_GET_QUFIELD2 etc.")
  call MasIncludeComment2("duf_sql_open", "duf_sql_open")
  call MasIncludeComment2("duf_sql_positional", "duf_sql_column_long_long etc.")
  call MasIncludeComment2("duf_sql_prepared", "duf_sql_prepare; duf_sql_step; duf_sql_finalize;")
  ...
  call MasIncludeComment2("duf_sql_types", "duf_stmnt_t; duf_sqltype_t; duf_sqexe_cb_t")
  ...
  call MasIncludeComment2("sql_beginning_types", "duf_sql_sequence_t")
endfunction
function! MasCurrent()
