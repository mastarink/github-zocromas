...
static const duf_longval_extended_t _lo_extended[] = {
  {.o = {DO_Q( "add-path" ), /*       */ DO_A_N, /* */ DO_VF( ADD_PATH )} /*      */ , DO_CL( CONTROL ) /*   */ , DO_H( reg.init path ) /*      */ },
  {.o = {DO_Q( "collect" ), /*        */ DO_A_N, /* */ DO_VF( COLLECT )} /*       */ , DO_CL( CONTROL ) /*   */ , DO_H( collect mode ) /*       */ },
  {.o = {DO_Q( "crc32" ), /*          */ DO_A_N, /* */ DO_VF( CRC32 )} /*         */ , DO_CL( SCAN ) /*      */ , DO_H( collect crc32 data ) /* */ },
  {.o = {DO_Q( "crc32id" ), /*        */ DO_A_R, /* */ DO_V( CRC32ID )} /*        */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "create-tables" ), /*  */ DO_A_N, /* */ DO_VF( CREATE_TABLES )} /* */ , DO_CL( SYSTEM ) /*    */ , DO_H( create tables ) /*      */ },
  {.o = {DO_Q( "db-directory" ), /*   */ DO_A_R, /* */ DO_V( DB_DIRECTORY )} /*   */ , DO_CL( CONTROL ) /*   */ , DO_H( db directory ) /*       */ },
  {.o = {DO_Q( "db-name-adm" ), /*    */ DO_A_R, /* */ DO_V( DB_NAME_ADM )} /*    */ , DO_CL( CONTROL ) /*   */ , DO_H( db name adm ) /*        */ },
  {.o = {DO_Q( "db-name" ), /*        */ DO_A_R, /* */ DO_V( DB_NAME_MAIN )} /*   */ , DO_CL( CONTROL ) /*   */ , DO_H( db name main ) /*       */ },
  {.o = {DO_Q( "debug" ), /*          */ DO_A_O, /* */ DO_V( DEBUG )} /*          */ , DO_CL( DEBUG ) /*     */ , DO_H( verbose ) /*            */ },
  {.o = {DO_Q( "directories" ), /*    */ DO_A_N, /* */ DO_VF( DIRS )} /*          */ , DO_CL( COLLECT ) /*   */ , DO_H( collect dir info ) /*   */ },
  {.o = {DO_Q( "dirent" ), /*         */ DO_A_N, /* */ DO_VF( DIRENT )} /*        */ , DO_CL( COLLECT ) /*   */ , DO_H( dirent ) /*             */ },
  {.o = {DO_Q( "dirs" ), /*           */ DO_A_N, /* */ DO_VF( DIRS )} /*          */ , DO_CL( COLLECT ) /*   */ , DO_H( get dir info ) /*       */ },
  {.o = {DO_Q( "disable-calculate" ), DO_A_N, /*    */ DO_VF( DISABLE_CALCULATE )}, DO_CL( COLLECT ) /*      */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "disable-insert" ), /* */ DO_A_N, /* */ DO_VF( DISABLE_INSERT )}, DO_CL( COLLECT ) /*         */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "disable-update" ), /* */ DO_A_N, /* */ DO_VF( DISABLE_UPDATE )}, DO_CL( COLLECT ) /*         */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "drop-tables" ), /*    */ DO_A_N, /* */ DO_VF( DROP_TABLES )} /*   */ , DO_CL( SYSTEM ) /*    */ , DO_H( drop tables ) /*        */ },
  {.o = {DO_Q( "dry-run" ), /*        */ DO_A_N, /* */ DO_V( DRY_RUN_TRACE )} /*  */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "exif" ), /*           */ DO_A_N, /* */ DO_VF( EXIF )} /*          */ , DO_CL( SCAN ) /*      */ , DO_H( collect exif data ) /*  */ },
  {.o = {DO_Q( "exifid" ), /*         */ DO_A_R, /* */ DO_V( EXIFID )} /*         */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "explain" ), /*        */ DO_A_O, /* */ DO_V( EXPLAIN_TRACE )} /*  */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "filedata" ), /*       */ DO_A_N, /* */ DO_VF( FILEDATA )} /*      */ , DO_CL( COLLECT ) /*   */ , DO_H( get filedata ) /*       */ },
  {.o = {DO_Q( "filenames" ), /*      */ DO_A_N, /* */ DO_VF( FILENAMES )} /*     */ , DO_CL( COLLECT ) /*   */ , DO_H( get filenames ) /*      */ },
  {.o = {DO_Q( "files" ), /*          */ DO_A_N, /* */ DO_VF( FILES )} /*         */ , DO_CL( COLLECT ) /*   */ , DO_H( get file info ) /*      */ },
  ...
  {.o = {DO_Q( "info" ), /*           */ DO_A_N, /* */ DO_VF( INFO )} /*          */ , DO_CL( REFERENCE ) /* */ , DO_H( db info ) /*            */ },
  {.o = {DO_Q( "information" ), /*    */ DO_A_N, /* */ DO_VF( INFO )} /*          */ , DO_CL( REFERENCE ) /* */ , DO_H( db info ) /*            */ },
  {.o = {DO_Q( "integrity" ), /*      */ DO_A_N, /* */ DO_VF( INTEGRITY )} /*     */ , DO_CL( REFERENCE ) /* */ , DO_H( db integrity ... ) /*   */ },
  {.o = {DO_Q( "max-dbg-lines" ), /*  */ DO_A_R, /* */ DO_V( MAX_DBGLINE )} /*    */ , DO_CL( DEBUG ) /*     */ , DO_H( verbose ) /*            */ },
  {.o = {DO_Q( "max-depth" ), /*      */ DO_A_R, /* */ DO_V( MAXDEPTH )} /*       */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  ...
  {.o = {DO_Q( "max-same" ), /*       */ DO_A_R, /* */ DO_V( MAXSAME )} /*        */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "max-seq" ), /*        */ DO_A_R, /* */ DO_V( MAXSEQ )} /*         */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "max-size" ), /*       */ DO_A_R, /* */ DO_V( MAXSIZE )} /*        */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "md5" ), /*            */ DO_A_N, /* */ DO_VF( MD5 )} /*           */ , DO_CL( SCAN ) /*      */ , DO_H( collect md5 data ) /*   */ },
  {.o = {DO_Q( "md5id" ), /*          */ DO_A_R, /* */ DO_V( MD5ID )} /*          */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "mdpath" ), /*         */ DO_A_N, /* */ DO_VF( MDPATH )} /*        */ , DO_CL( SCAN ) /*      */ , DO_H(  ... ..... ) /*         */ },
  {.o = {DO_Q( "memusage" ), /*       */ DO_A_N, /* */ DO_V( MEMUSAGE )} /*       */ , DO_CL( DEBUG ) /*     */ , DO_H( verbose ) /*            */ },
  {.o = {DO_Q( "mime" ), /*           */ DO_A_N, /* */ DO_VF( MIME )} /*          */ , DO_CL( SCAN ) /*      */ , DO_H( collect mime data ) /*  */ },
  {.o = {DO_Q( "mimeid" ), /*         */ DO_A_R, /* */ DO_V( MIMEID )} /*         */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "min-dbg-lines" ), /*  */ DO_A_R, /* */ DO_V( MIN_DBGLINE )} /*    */ , DO_CL( DEBUG ) /*     */ , DO_H( verbose ) /*            */ },
  {.o = {DO_Q( "min-dirfiles" ), /*   */ DO_A_R, /* */ DO_V( MINDIRFILES )} /*    */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "min-same" ), /*       */ DO_A_R, /* */ DO_V( MINSAME )} /*        */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "min-size" ), /*       */ DO_A_R, /* */ DO_V( MINSIZE )} /*        */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  ...
  {.o = {DO_Q( "print" ), /*          */ DO_A_N, /* */ DO_VF( PRINT )} /*         */ , DO_CL( PRINT ) /*     */ , DO_H( print ) /*              */ },
  {.o = {DO_Q( "progress" ), /*       */ DO_A_N, /* */ DO_VF( PROGRESS )} /*      */ , DO_CL( REFERENCE ) /* */ , DO_H( progress ) /*           */ },
  {.o = {DO_Q( "recursive" ), /*      */ DO_A_N, /* */ DO_VF( RECURSIVE )} /*     */ , DO_CL( CONTROL ) /*   */ , DO_H( recursive ) /*          */ },
  {.o = {DO_Q( "remove-database" ), /* */ DO_A_N, /* */ DO_VF( REMOVE_DATABASE )}, DO_CL( SYSTEM ) /*        */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "same" ), /*           */ DO_A_R, /* */ DO_V( SAME )} /*           */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "sample" ), /*         */ DO_A_O, /* */ DO_V( SAMPLE )} /*         */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "sampupd" ), /*        */ DO_A_O, /* */ DO_V( SAMPUPD )} /*        */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "sd5" ), /*            */ DO_A_N, /* */ DO_VF( SD5 )} /*           */ , DO_CL( SCAN ) /*      */ , DO_H( collect sd5 data ) /*   */ },
  {.o = {DO_Q( "sd5id" ), /*          */ DO_A_R, /* */ DO_V( SD5ID )} /*          */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "size" ), /*           */ DO_A_R, /* */ DO_V( SIZE )} /*           */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "summary" ), /*        */ DO_A_N, /* */ DO_VF( SUMMARY )} /*       */ , DO_CL( REFERENCE ) /* */ , DO_H( summary ) /*            */ },
  {.o = {DO_Q( "test-option" ), /*    */ DO_A_R, /* */ DO_V( TEST )} /*           */ , DO_CL( DEBUG ) /*     */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "trace-action" ), /*   */ DO_A_O, /* */ DO_V( ACTION_TRACE )} /*   */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-all" ), /*      */ DO_A_O, /* */ DO_V( ALL_TRACE )} /*      */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-any" ), /*      */ DO_A_O, /* */ DO_V( ANY_TRACE )} /*      */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-calls" ), /*    */ DO_A_O, /* */ DO_V( CALLS_TRACE )} /*    */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-collect" ), /*  */ DO_A_O, /* */ DO_V( COLLECT_TRACE )} /*  */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-crc32" ), /*    */ DO_A_O, /* */ DO_V( CRC32_TRACE )} /*    */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-current" ), /*  */ DO_A_O, /* */ DO_V( CURRENT_TRACE )} /*  */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-deleted" ), /*  */ DO_A_O, /* */ DO_V( DELETED_TRACE )} /*  */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-dirent" ), /*   */ DO_A_O, /* */ DO_V( DIRENT_TRACE )} /*   */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-error" ), /*    */ DO_A_O, /* */ DO_V( ERROR_TRACE )} /*    */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-exif" ), /*     */ DO_A_O, /* */ DO_V( EXIF_TRACE )} /*     */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-explain" ), /*  */ DO_A_O, /* */ DO_V( EXPLAIN_TRACE )} /*  */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-file" ), /*     */ DO_A_R, /* */ DO_V( TRACE_FILE )} /*     */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-fs" ), /*       */ DO_A_O, /* */ DO_V( FS_TRACE )} /*       */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-insert" ), /*   */ DO_A_O, /* */ DO_V( INSERT_TRACE )} /*   */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-integrity" ), /* */ DO_A_O, /* */ DO_V( INTEGRITY_TRACE )} /* */ , DO_CL( TRACE ) /*   */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-match" ), /*    */ DO_A_O, /* */ DO_V( MATCH_TRACE )} /*    */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-md5" ), /*      */ DO_A_O, /* */ DO_V( MD5_TRACE )} /*      */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-mdpath" ), /*   */ DO_A_O, /* */ DO_V( MDPATH_TRACE )} /*   */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-mime" ), /*     */ DO_A_O, /* */ DO_V( MIME_TRACE )} /*     */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-nonew" ), /*    */ DO_A_O, /* */ DO_V( TRACE_NONEW )} /*    */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-options" ), /*  */ DO_A_O, /* */ DO_V( OPTIONS_TRACE )} /*  */ , DO_CL( NODESC ) /*    */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-path" ), /*     */ DO_A_O, /* */ DO_V( PATH_TRACE )} /*     */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-sample" ), /*   */ DO_A_O, /* */ DO_V( SAMPLE_TRACE )} /*   */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-samupd" ), /*   */ DO_A_O, /* */ DO_V( SAMPUPD_TRACE )} /*  */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-scandir" ), /*  */ DO_A_O, /* */ DO_V( SCAN_DE_DIR_TRACE )}, DO_CL( TRACE ) /*         */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-scan" ), /*     */ DO_A_O, /* */ DO_V( SCAN_TRACE )} /*     */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-scanreg" ), /*  */ DO_A_O, /* */ DO_V( SCAN_DE_REG_TRACE )}, DO_CL( TRACE ) /*         */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-sd5" ), /*      */ DO_A_O, /* */ DO_V( SD5_TRACE )} /*      */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-select" ), /*   */ DO_A_O, /* */ DO_V( SELECT_TRACE )} /*   */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-seq" ), /*      */ DO_A_O, /* */ DO_V( SEQ_TRACE )} /*      */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-sql" ), /*      */ DO_A_O, /* */ DO_V( SQL_TRACE )} /*      */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  ...
  {.o = {DO_Q( "trace-temp" ), /*     */ DO_A_O, /* */ DO_V( TEMP_TRACE )} /*     */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "trace-update" ), /*   */ DO_A_O, /* */ DO_V( UPDATE_TRACE )} /*   */ , DO_CL( TRACE ) /*     */ , DO_H( trace .... ) /*         */ },
  {.o = {DO_Q( "tree2db" ), /*        */ DO_A_N, /* */ DO_V( TREE_TO_DB )} /*     */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "tree" ), /*           */ DO_A_N, /* */ DO_VF( TREE )} /*          */ , DO_CL( PRINT ) /*     */ , DO_H( tree ) /*               */ },
  {.o = {DO_Q( "tree-to-db" ), /*     */ DO_A_N, /* */ DO_V( TREE_TO_DB )} /*     */ , DO_CL( NODESC ) /*    */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "uni-scan" ), /*       */ DO_A_N, /* */ DO_VF( UNI_SCAN )} /*      */ , DO_CL( OBSOLETE ) /*  */ , DO_H(  .... ) /*              */ },
  {.o = {DO_Q( "vacuum" ), /*         */ DO_A_N, /* */ DO_VF( VACUUM )} /*        */ , DO_CL( SYSTEM ) /*    */ , DO_H( vacuum db ) /*          */ },
  {.o = {DO_Q( "verbose" ), /*        */ DO_A_O, /* */ DO_V( VERBOSE )} /*        */ , DO_CL( DEBUG ) /*     */ , DO_H( verbose ) /*            */ },
  {.o = {DO_Q( "version" ), /*        */ DO_A_N, /* */ DO_V( VERSION )} /*        */ , DO_CL( REFERENCE ) /* */ , DO_H( db info ) /*            */ },
