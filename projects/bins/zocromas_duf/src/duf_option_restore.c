...
duf_restore_some_option( char *ptr, duf_option_code_t codeval, size_t maxlen )
{
  ...
  DUF_OPTION_RESTORE_FLAG( codeval, ptr, ALLOW_FILES, allow_files, cli.act, maxlen );
  /* 20150907.122929 renamed  DIRS -> ALLOW_DIRS */
  DUF_OPTION_RESTORE_FLAG( codeval, ptr, ALLOW_DIRS, allow_dirs, cli.act, maxlen );
  ...
  DUF_OPTION_RESTORE_STR( codeval, ptr, DB_NAME_ADM, name, db.tempo, maxlen );
  DUF_OPTION_RESTORE_STR( codeval, ptr, DB_NAME_SELECTED, name, db.selected, maxlen );
