...
duf_check_table_filedatas( void )
{
  ...
  r = duf_sql_exec_msg( "CREATE TABLE IF NOT EXISTS"
                        ...
                        " size INTEGER, md5id INTEGER, filetype TEXT, filestatus INTEGER, ucnt INTEGER, now REAL)",
...
duf_check_table_keydata( void )
{
  ...
  r = duf_sql_exec_msg( "CREATE TABLE IF NOT EXISTS"
                        ...
                        " filenameid INTEGER NOT NULL, pathid INTEGER NOT NULL, ucnt INTEGER, now REAL)", "Create duf_keydata" );
  r = duf_sql_exec_msg( "CREATE UNIQUE INDEX IF NOT EXISTS keydata_uniq ON duf_keydata " " (pathid,filenameid,md5id)", "Create duf_keydata" );
...
duf_check_table_mdpath( void )
{
  ...
  r = duf_sql_exec_msg( "CREATE TABLE IF NOT EXISTS"
                        ...
                        " dupcnt INTEGER, ucnt INTEGER, now REAL)", "Create duf_mdpath" );
...
duf_check_tables( void )
{
  ...
  r = duf_sql_exec_msg( "CREATE TABLE IF NOT EXISTS"
                        ...
                        " d INTEGER, broken_date TEXT, ucnt INTEGER, now REAL)", "Create duf_exif" );
