...
duf_sql_sequence_t sql_beginning_tables = {
  ...
  .sql = {
          ...
          "DROP TABLE IF EXISTS " DUF_SQL_TABLES_TMP_TDB_OPTIONS /* */ ,
#endif
          "CREATE " DUF_SQL_TTABLES_TEMPORARY_STRING " TABLE  IF NOT EXISTS " DUF_SQL_TABLES_TMP_TDB_OPTIONS " ( "
#ifdef DUF_USE_IDCOL
          DUF_SQL_IDNAME " INTEGER PRIMARY KEY autoincrement, "
#endif
	  " oval INTEGER NOT NULL, name TEXT NOT NULL, arg TEXT NOT NULL" /* */
          " )",                 /* */
          "CREATE INDEX IF NOT EXISTS " DUF_SQL_TABLES_TMP_TDB_OPTIONS "_names ON " DUF_SQL_TABLES_TMP_TDB_OPTIONS " (name)", /* */
          ...
          " GROUP BY fn.Pathid " /* */ ,
//"CREATE UNIQUE INDEX IF NOT EXISTS " DUF_SQL_TABLES_TMP_PATHTOT_FILES_FULL "_rowid ON " DUF_SQL_TABLES_TMP_PATHTOT_FILES_FULL " (rowid) " /* */        ,
          "CREATE UNIQUE INDEX IF NOT EXISTS " DUF_SQL_TABLES_TMP_PATHTOT_FILES_FULL "_Pathid ON " DUF_SQL_TABLES_TMP_PATHTOT_FILES_FULL " (Pathid)"
          /* */ ,
          "CREATE INDEX IF NOT EXISTS        " DUF_SQL_TABLES_TMP_PATHTOT_FILES_FULL "_numfiles ON " DUF_SQL_TABLES_TMP_PATHTOT_FILES_FULL " (numfiles)" /* */
          ,
#ifndef DUF_SQL_TABLES_TEMPORARY
...
//"CREATE UNIQUE INDEX IF NOT EXISTS " DUF_SQL_TABLES_TMP_PATHTOT_DIRS_FULL "_rowid ON " DUF_SQL_TABLES_TMP_PATHTOT_DIRS_FULL " (rowid) " /* */        ,
          "CREATE UNIQUE INDEX IF NOT EXISTS " DUF_SQL_TABLES_TMP_PATHTOT_DIRS_FULL "_Pathid ON " DUF_SQL_TABLES_TMP_PATHTOT_DIRS_FULL " (Pathid)"
          /* */ ,
          "CREATE INDEX IF NOT EXISTS        " DUF_SQL_TABLES_TMP_PATHTOT_DIRS_FULL "_numdirs ON " DUF_SQL_TABLES_TMP_PATHTOT_DIRS_FULL " (numdirs)"
          /* */ ,
          /* TODO:
           * md5cnt
           * sd5cnt
