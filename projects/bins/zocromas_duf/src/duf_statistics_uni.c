...
static int
duf_file_scan_statistics_uni(  duf_depthinfo_t * pdi,
...
static int
duf_directory_scan_statistics_uni( unsigned long long pathid, /* const duf_dirhandle_t * pdh_notused, */ duf_depthinfo_t * pdi,
