...
DRP( PDI, duf_stmnt_t *, pstmt, NULL, pdi_prepare_statement_by_id, duf_depthinfo_t * pdi, const char *sql, duf_stmt_ident_t stmtid );
...
DR( PDI, pdi_finalize_statement_by_stmt, duf_depthinfo_t * pdi, duf_stmnt_t * pstmt );
