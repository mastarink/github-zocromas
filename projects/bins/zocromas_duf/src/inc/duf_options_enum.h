...
/* db general */
  ...
  DUF_OPTION_FLAG_INTERACTIVE,
  DUF_OPTION_FLAG_PROGRESS,
  DUF_OPTION_FLAG_BEGINNING_SQL,

  /* i/o */
  DUF_OPTION_OUTPUT_LEVEL,
  DUF_OPTION_OUTPUT_FILE,
  DUF_OPTION_OUTPUT_STDERR,
  DUF_OPTION_OUTPUT_STDOUT,
  DUF_OPTION_FORMAT,
  ...
  DUF_OPTION_CONFIG_TRACE,
  DUF_OPTION_CALLS_TRACE,
  DUF_OPTION_DEPTH_TRACE,
...
/* /actions */
  ...
  DUF_OPTION_EXIFDT,
  DUF_OPTION_MINEXIFDT,
  DUF_OPTION_MAXEXIFDT,
  ...
  DUF_OPTION_EXIFSAME,
  DUF_OPTION_MINEXIFSAME,
  DUF_OPTION_MAXEXIFSAME,

  DUF_OPTION_MIMESAME,
  DUF_OPTION_MINMIMESAME,
  DUF_OPTION_MAXMIMESAME,
  ...
  DUF_OPTION_FLAG_DO_SCCBS,
  DUF_OPTION_FLAG_SHOW_SCCBS,
  DUF_OPTION_FLAG_SHOW_SCCBH,
