...
# include "duf_option_data_types.h"                                  /* duf_xclarifier_t etc... ♠ */

# include "duf_se.h"                                                 /* DR; SR; ER; CR; QSTR; QERRIND; QERRNAME etc. ♠ */

DR( OPTIONS, soption_xclarify_new_at_stdx_default_with_pod, duf_config_cli_t * cli, const char *string, const char *name, const char *arg,
...
DR( OPTIONS, soption_xclarify_snac_new_at_stdx_default, duf_config_cli_t * cli, const char *string, const char *name, const char *arg,
...
DR( OPTIONS, soption_xclarify_sna_new_at_stdx_default, duf_config_cli_t * cli, const char *string, const char *name, const char *arg,
    char value_separator, duf_option_stage_t istage, duf_option_source_t source, duf_option_adata_t * paod );
DR( OPTIONS, soption_xclarify_na_new_at_stdx_default, duf_config_cli_t * cli, const char *name, const char *arg, char value_separator,
...
DR( OPTIONS, soption_xclarify_new_booted_source, duf_config_cli_t * cli, duf_option_stage_t istage, duf_option_source_t source,
    duf_option_adata_t * paod );
