...
FILE *duf_trace_file_c( const duf_config_trace_t * cfg );
int duf_trace_output_force_color_c( const duf_config_trace_t * tcfg );
int duf_trace_output_no_color_c( const duf_config_trace_t * tcfg );
