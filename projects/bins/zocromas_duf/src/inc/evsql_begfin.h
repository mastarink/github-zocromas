 ...
 * 5. end statement * */
int duf_eval_sql_one_cb( const char *sql, const duf_ufilter_t * pu, duf_bind_cb_t callback, const duf_argvc_t * ttarg, const char *selected_db,
                         int *pchanges ) __attribute__ ( ( warn_unused_result ) );

/* 20150913.101952
 *  evaluate one sql statement without callback 
 * */
int duf_eval_sql_one( const char *sql, const duf_ufilter_t * pu, const char *selected_db, int *pchanges );
