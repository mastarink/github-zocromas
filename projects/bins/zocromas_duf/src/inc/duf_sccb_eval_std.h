...
int duf_ev_pdi_evnamen_std_pt( duf_depthinfo_t * pdi, const char *name, size_t namelen, duf_argvc_t * ptarg )
      __attribute__ ( ( warn_unused_result ) );
int duf_ev_pdi_evname_std_pt( duf_depthinfo_t * pdi, const char *name, duf_argvc_t * ptarg ) __attribute__ ( ( warn_unused_result ) );
