...
void duf_pi_levinfo_clear_d( duf_pathinfo_t * pi, int d );
void duf_pi_levinfo_clear_up( duf_pathinfo_t * pi );
void duf_pi_levinfo_clear( duf_pathinfo_t * pi );

void duf_pi_levinfo_clear_all( duf_pathinfo_t * pi );
