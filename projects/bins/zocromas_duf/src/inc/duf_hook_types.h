...
typedef int ( *duf_str_cb2_t ) ( struct duf_sccb_handle_s /* duf_sccb_handle_t */  * sccbh, duf_stmnt_t * pstmt, duf_scanstage_t scanstage );
...
typedef int ( *duf_sel_cb2_t ) ( struct duf_sccb_handle_s /* duf_sccb_handle_t */  * sccbh, duf_stmnt_t * pstmt, duf_str_cb2_t str_cb,
