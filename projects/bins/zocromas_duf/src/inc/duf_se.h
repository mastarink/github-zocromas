...
# define DTS( _layer_id, _funtyp, _rvar,        _pre, _typid, _funname, ... ) DTX(_layer_id, _funtyp, _rvar,    , _pre, _typid, _funname, __VA_ARGS__ )
...
# define STX( _layer_id, _funtyp, _rvar, _vini, _pre, _typid, _funname, ... )  DTX( _layer_id, _funtyp, _rvar, _vini, , _typid, _funname, __VA_ARGS__ ) \
			{ /* S */ \
			  ...
			  mas_fundecl_t fundecl_={.layer_id= DUF_LAYER_ ## _layer_id,.r={.ul=0}}; \
  			  STTT( typeof(fundecl_.r._typid), fundecl_.r._typid )
# define STS( _layer_id, _funtyp, _rvar,        _pre, _typid, _funname, ... )  DTS( _layer_id, _funtyp, _rvar,        , _typid, _funname, __VA_ARGS__ ) \
			{ /* S */ \
			  _funtyp _rvar={0}; \
			  mas_fundecl_t fundecl_={.layer_id= DUF_LAYER_ ## _layer_id,.r={.ul=0}}; \
  			  STTT( typeof(fundecl_.r._typid), fundecl_.r._typid )
...
# define ETX( _layer_id, _funtyp, _rvar, _vini, _pre, _typid, _funname, ... ) \
			...
			return _rvar
# define ETS( _layer_id, _funtyp, _rvar,        _pre, _typid, _funname, ... ) \
			  ETX( _layer_id, _funtyp, _rvar,     , _pre, _typid, _funname, __VA_ARGS__ )
...
# define DRS( _layer_id, _funtyp, _rvar,        _funname, ... )	DTS( _layer_id, _funtyp, _rvar,       	 ,	ei, _funname, __VA_ARGS__ )
...
# define SRS( _layer_id, _funtyp, _rvar,        _funname, ... )	STS( _layer_id, _funtyp, _rvar,       			,	ei, _funname, __VA_ARGS__ )
...
# define ERS( _layer_id, _funtyp, _rvar,        _funname, ... )	ETS( _layer_id, _funtyp, _rvar,        TER,	ei, _funname, __VA_ARGS__ )
...
# define CR_(            _funname, ... )	QDOCR_( CRX(_funname, __VA_ARGS__ ) )
