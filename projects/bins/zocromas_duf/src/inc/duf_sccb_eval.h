 ...
 * pdi_evnamen_std_pt:	  ( duf_depthinfo_t * pdi,     const char *name, size_t namelen, duf_argvc_t * ptarg ; with standard action table ...
 *
 * pdi_evname:	          ( duf_depthinfo_t * pdi, z/t const char *name,                 const duf_action_table_t * table ...
 * pdi_evname_pt:         ( duf_depthinfo_t * pdi, z/t const char *name,                 const duf_action_table_t * table, duf_argvc_t * ptarg ...
 ...
 * pdi_evname_std_pt:	  ( duf_depthinfo_t * pdi, z/t const char *name, duf_argvc_t * ptarg; with standard action table ...
