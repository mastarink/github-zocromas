...
static int _modname ## _init( duf_depthinfo_t * pdi ); \
...
static int _modname ## _de_file_before2( duf_depthinfo_t * pdi ); \
static int _modname ## _de_dir_before2( duf_depthinfo_t * pdi );
