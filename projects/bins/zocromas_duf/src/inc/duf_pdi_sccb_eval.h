...
int duf_ev_pdi_sccb( duf_depthinfo_t * pdi, duf_scan_callbacks_t * sccb, duf_argvc_t * ptarg ) __attribute__ ( ( warn_unused_result ) );
int duf_ev_pdi_evnamed_list( duf_depthinfo_t * pdi, const char *names, const duf_action_table_t * table,
                             duf_argvc_t * ptarg ) __attribute__ ( ( warn_unused_result ) );
...
int duf_ev_pdi_evname_at( duf_depthinfo_t * pdi, const char *name, const duf_action_table_t * table,
                          const char *arg ) __attribute__ ( ( warn_unused_result ) );
