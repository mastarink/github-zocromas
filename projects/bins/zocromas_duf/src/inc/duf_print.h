...
/*                              const char *format, duf_pdi_scb_t prefix_scb, duf_pdi_scb_t suffix_scb, size_t max_width, size_t * pslen, */
/*                              size_t * pwidth, int *pover );                                                                            */
DRX( OTHER, char *, buffer, NULL, sformat_file_info, const duf_depthinfo_t * pdi, int use_row, duf_sccb_handle_t * sccbh, duf_fileinfo_t * pfi,
...
/*                                     duf_pdi_scb_t prefix_scb, duf_pdi_scb_t suffix_scb, size_t max_width, int force_color, int nocolor,            */
/*                                     size_t * pswidth, int *pover );                                                                                */
DRX( OTHER, size_t, slen, 0, print_sformat_file_info, const duf_depthinfo_t * pdi, int use_row, duf_sccb_handle_t * sccbh, duf_fileinfo_t * pfi,
