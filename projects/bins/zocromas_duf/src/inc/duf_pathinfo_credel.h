...
void duf_pi_copy( duf_pathinfo_t * pidst, const duf_pathinfo_t * pisrc, int no_li , int no_clear );

void duf_pi_init_level_d( duf_pathinfo_t * pi, const char *itemname, unsigned long long dirid, duf_node_type_t node_type, int d );
void duf_pi_dbinit_level_d( duf_pathinfo_t * pi, duf_stmnt_t * pstmt_arg, duf_node_type_t node_type, int d );
