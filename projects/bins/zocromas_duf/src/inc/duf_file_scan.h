 ...
 * */
int duf_sql_scan_print_file( unsigned long long pathid, unsigned long long filenameid,
                             const char *name,  void *str_cb_udata, duf_dirinfo_t * pdi, duf_scan_callbacks_t * sccb,
                             duf_record_t * precord );


int duf_scan_vfiles_sql( duf_scan_callback_file_t str_cb, void *str_cb_udata, duf_dirinfo_t * pdi, duf_scan_callbacks_t * sccb,
                         const char *sql, va_list args );
int duf_scan_items_sql( duf_scan_callback_file_t str_cb, void *str_cb_udata, duf_dirinfo_t * pdi, duf_scan_callbacks_t * sccb,
                        const char *sql, ... );
