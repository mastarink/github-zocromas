...
const duf_longval_extended_t optable_trace[] = {
  ...
  {.o = {DO_Q( "trace-stdout" ) /*      */ , DO_A_N /* */ , DO_V( TRACE_STDOUT )} /*   */ , DO_CL( TRACE ) /*   */ ,
   /*      */ DO_O( FILE, cli.trace.output ),.call = {.value = {.u = 1}}, DO_STAGE_ANY(  ) /*              */ , DO_H( trace .... )},
