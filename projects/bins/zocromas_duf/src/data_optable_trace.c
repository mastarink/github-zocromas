...
#define DUF_TRACE_OPT(_lname, _uname) \
   {.o = {DO_Q( "trace-" #_lname), DO_A_O, DO_V( _uname ## _TRACE )}, DO_CL( TRACE ), DO_OC( UPLUS, opt.trace._lname )  , DO_STAGE_ANY  , DO_H( trace .... )  }
