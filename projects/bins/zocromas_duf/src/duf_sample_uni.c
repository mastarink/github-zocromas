...
static int
duf_file_scan_sample_uni(  duf_depthinfo_t * pdi,
...
/* will be static! */
int
duf_directory_scan_sample_uni( unsigned long long pathid, /* const duf_dirhandle_t * pdh_notused, */ duf_depthinfo_t * pdi,
...
static int
duf_directory_scan_sample_uni_after( unsigned long long pathid, /* const duf_dirhandle_t * pdh_notused, */ duf_depthinfo_t * pdi,
                                     duf_record_t * precord )
{
  int r = 0;
...
static int
duf_directory_scan_sample_uni_middle( unsigned long long pathid, /* const duf_dirhandle_t * pdh_notused, */ duf_depthinfo_t * pdi,
                                      duf_record_t * precord )
{
  int r = 0;
