...
int
duf_tmpdb_add( duf_config_cli_t * cli, int oval, const char *optname, const char *optargg )
{
  DUF_STARTR( r );
  ...
  DOR( r, duf_eval_sqlsq_cb( &tmpseq, NULL /* title */ , ( duf_ufilter_t * ) NULL, ( duf_yfilter_t * ) NULL, duf_bind_tmp, &ttarg,
