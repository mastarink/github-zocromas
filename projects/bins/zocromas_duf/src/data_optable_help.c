...
const duf_longval_extended_t optable_help[] = {
  {.o = {DO_Q( "version" ) /*           */ , DO_A_N /* */ } /*                             */ , DO_CL( REFERENCE ) /*  */ ,
   /*      */ DO_T( A_CALL ), DO_A_CALL( version ) /*     */ , DO_AT_STAGE( 1 ) /*          */ , DO_H( version info ) /*                   */ },
  {.o = {DO_Q( "flags" ) /*             */ , DO_A_N /* */ } /*                             */ , DO_CL( REFERENCE ) /*  */ ,
   /*      */ DO_T( A_CALL ), DO_A_CALL( showflags ) /*   */ , DO_AT_STAGE( 1 ) /*          */ , DO_H( version info ) /*                   */ },
  ...
  {.o = {DO_Q( "help-short" ) /*        */ , DO_A_N /* */, DO_V( HELP ) } /*                             */ , DO_CL( HELP ) /*       */ ,
