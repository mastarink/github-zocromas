...
const duf_longval_extended_t optable_flag[] = {
  ...
  {.o = {DO_Q( "crc32" ) /*             */ , DO_A_N /* */ , DO_VF( CRC32 )} /*             */ , DO_CL( SCAN ) /*    */ ,
   /*      */ DO_O( FLAG, cli.act.v ), DO_FL( act, crc32 ) /*                               */ , DO_H( collect crc32 ) /*                    */ },
  ...
  {.o = {DO_Q( "interactive" ) /*       */ , DO_A_N /* */ , DO_VF( INTERACTIVE )} /*       */ , DO_CL( CONTROL ) /* */ ,
   /*      */ DO_O( FLAG, cli.act.v ), DO_FL( act, interactive ) /*                                        */ , DO_H(  ... ) /*              */ },
  {.o = {DO_Q( "selection" ) /*         */ , DO_A_N /* */ , DO_VF( BEGINNING_SQL ) /*  */ } /* */ , DO_CL( CONTROL ) /*   */ ,
   /*      */ DO_O( FLAG, cli.act.v ), DO_FL( act, beginning_sql ), DO_STAGE_ANY(  ) /*     */ , DO_H(  ... ) /*                             */ },
  ...
  {.o = {DO_Q( "if-recursive" ) /*      */ , DO_A_N} /*                                    */ , DO_CL( CONTROL ) /* */ ,
   /*      */ DO_OU( PSFLAG, v ), DO_FL( u, recursive ), DO_STAGE_SAME( 1 ) /*              */ , DO_H( recursive ) /*                        */ },
