...
/* ###################################################################### */
#  define MAST_IF_TR_WHAT_C(  _cfg, _what, _name )		(( _cfg /* && !_cfg->MAST_TRACE_AT_CFG_ nonew*/ ) ? _cfg->_what _name: 1 )
...
#  define MAST_IF_TR_WHATN_C( _cfg, _what, _name, _min )		( _cfg /* && !_cfg->MAST_TRACE_AT_CFG_ nonew */ && _cfg->_what _name > _min )
...
#  define MAST_IF_TRACE_WHAT_C(  _cfg, _what, _name )		(( _cfg /* && !_cfg->MAST_TRACE_AT_CFG_ nonew */) ? _cfg->_what _name : 1 )
...
#  define MAST_IF_TRACE_WHATN_C( _cfg, _what, _name, _min )	( _cfg /* && !_cfg->MAST_TRACE_AT_CFG_ nonew */ && _cfg->_what _name > _min )
