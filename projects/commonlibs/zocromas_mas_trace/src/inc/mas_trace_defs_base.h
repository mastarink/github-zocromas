...
#  define MAST_OTRACE_WHAT_WP_BASE( _out, _tcfg, _prefix, _signum, _flags, _ern, _what, _name, _min, ... ) \
	...
	/* flags, nerr */		_flags, _ern, \
        /* (* out *)                       _out,  */ \
			    		_prefix, \
                                        /* _tcfg->fun_width                        (* MAST_TRACE_FUNWIDTH_C( _tcfg ) *),  */ \
                                        /* _tcfg->stream.v.flag.force_color        (* MAST_TRACE_FORCE_COLOR_C( _tcfg ) *),  */ \
                                        /* _tcfg->stream.v.flag.nocolor            (* MAST_TRACE_NOCOLOR_C( _tcfg ) *) ,  */ \
			    		__VA_ARGS__ )
#else
#  define MAST_OTRACE_WHAT_WP_BASE( _out, _tcfg, _prefix, _signum, _flags, _ern, _what, _name, _min, ... ) 
#endif
