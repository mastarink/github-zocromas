#ifndef MAS_MUC_OPTIONS_INTERACTIVE_H
# define MAS_MUC_OPTIONS_INTERACTIVE_H
...
muc_DR( OPTIONS, source_interactive_parse, muc_config_cli_t * cli, muc_option_stage_t istage, muc_int_void_func_t cb_do_interactive,
