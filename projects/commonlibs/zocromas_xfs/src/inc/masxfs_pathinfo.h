...
int masxfs_pathinfo_scan( masxfs_pathinfo_t * pi, masxfs_entry_callback_t * callbacks, unsigned long flags, masxfs_depth_t maxdepth );
...
void masxfs_pathinfo_each_depth_cb( masxfs_pathinfo_t * pi, masxfs_li_cb_t cb, void *udata _uUu_ );
