...
mucs_source_t *mucs_source_create_setup( mucs_source_type_t source_type, const char *name, int count, const void *data_ptr, int min_pass,
                                         int npasses, const char *delims, const char *eq, const mucs_prefix_encoder_t * pref_ids );
