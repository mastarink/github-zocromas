...
int mucs_source_load_targ( mucs_source_han_t * osrc );

int mucs_source_lookup_seq( mucs_source_han_t * osrc, const mucs_option_table_list_t * tablist );
int mucs_source_lookup_all( mucs_source_han_t * osrc, const mucs_option_table_list_t * tablist );
...
int mucs_source_set_common_callback( mucs_source_han_t * osrc, mucs_option_callback_t cb );
int mucs_source_set_type_callback( mucs_source_han_t * osrc, mucs_restype_t restype, mucs_option_callback_t cb );
