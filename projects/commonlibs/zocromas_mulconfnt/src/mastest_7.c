...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
  ...
  mucs_option_t options[] = {
    {"or1", 'O', MUCS_RTYP_ULONG | MUCS_RTYP_BW_OR, &app_uflags_or,.def_nvalue.v_ulong = 0x101,.val = 0, "app_uflags_or",.argdesc = "value",.flags = MUCS_FLAG_NO_VALUE | MUCS_FLAG_USE_DEF_NVALUE}, /* */
    {"or2", 'o', MUCS_RTYP_ULONG | MUCS_RTYP_BW_OR, &app_uflags_or,.def_nvalue.v_ulong = 0x404,.val = 0, "app_uflags_or",.argdesc = "value",.flags = MUCS_FLAG_NO_VALUE | MUCS_FLAG_USE_DEF_NVALUE}, /* */
    {"and1", 'A', MUCS_RTYP_ULONG | MUCS_RTYP_BW_AND, &app_uflags_and,.def_nvalue.v_ulong = 0x101,.val = 0, "app_uflags_and",.argdesc = "value",.flags = MUCS_FLAG_NO_VALUE | MUCS_FLAG_USE_DEF_NVALUE}, /* */
    ...
    {"and1a", '\0', MUCS_RTYP_ULONG | MUCS_RTYP_BW_AND, &app_uflags_and_a,.def_nvalue.v_ulong = 0x101,.val = 0, "app_uflags_and_a",.argdesc = "value",.flags = MUCS_FLAG_NO_VALUE | MUCS_FLAG_USE_DEF_NVALUE}, /* */
    {"and2a", '\0', MUCS_RTYP_ULONG | MUCS_RTYP_BW_AND, &app_uflags_and_a,.def_nvalue.v_ulong = 0x104,.val = 0, "app_uflags_and_a",.argdesc = "value",.flags = MUCS_FLAG_NO_VALUE | MUCS_FLAG_USE_DEF_NVALUE}, /* */
    ...
    {"nand3", '\0', MUCS_RTYP_ULONG | MUCS_RTYP_BW_AND | MUCS_RTYP_BW_NOT, &app_uflags_nand,.def_nvalue.v_ulong = 0xfff,.val = 0, "app_uflags_nand",.argdesc = "value",.flags = MUCS_FLAG_NO_VALUE | MUCS_FLAG_USE_DEF_NVALUE}, /* */
