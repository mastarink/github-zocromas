...
int
test_6( int _uUu_ argc, const char _uUu_ * argv[], int nseries, const char *series_suffix, int do_fprintf _uUu_ )
{
  int v_int0 = 0;
  int v_int1 = 0;
  int v_int2 = 0;
...
//  if ( file_exists(fname) )
    {
      ...
      mucs_source_han_t *osrc = mucs_source_list_add_source( plist, MUCS_SOURCE_FILE, 0, fname, ":\r\n", "=", NULL );
      ...
      masexam_next_group(  );
      masexam_exam( __LINE__, sizeof( v_long0 ) == 8 && v_long0 == 1099511627775L, "OK", "Error", "lnum0=%ld ? %ld", v_long0, 0xffffffffffL );
      masexam_exam( __LINE__, sizeof( v_long1 ) == 8 && v_long1 == 0xff, "OK", "Error", "lnum1=%ld ? %ld", v_long1, 0xffL );
      masexam_exam( __LINE__, sizeof( v_long2 ) == 8 && v_long2 == LONG_MAX, "OK", "Error", "lnum2=%ld ? %ld", v_long2, LONG_MAX );
      masexam_exam( __LINE__, sizeof( v_long2 ) == 8
      ...
      masexam_exam( __LINE__, sizeof( v_long3 ) == 8 && v_long3 == -12L, "OK", "Error", "lnum3=%ld ? %ld", v_long3, -12L );
      masexam_exam( __LINE__, sizeof( v_long4 ) == 8 && v_long4 == LONG_MIN, "OK", "Error", "lnum4=%ld ? %ld", v_long4, LONG_MIN );

      masexam_next_group(  );
      masexam_exam( __LINE__, sizeof( v_llong0 ) == 8
                    && v_llong0 == 5437LL, "OK", "Error", "%lld ? %lld (%d)", v_llong0, 5437LL, sizeof( v_llong0 ) );
      masexam_exam( __LINE__, sizeof( v_llong1 ) == 8
      ...
      masexam_exam( __LINE__, argvno && argvno[1]
                    && 0 == mas_strcmp( "something", argvno[1] ), "OK", "Error", "'%s' ? '%s'", "something", argvno[1] );
