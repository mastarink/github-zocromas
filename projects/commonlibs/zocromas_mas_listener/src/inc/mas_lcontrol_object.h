...
mas_lcontrol_t *mas_lcontrol_make( mas_options_t * popts, const char *host, unsigned port );
int mas_lcontrol_init( mas_lcontrol_t * plcontrol, mas_options_t * popts, const char *host, unsigned port );
