...
void masxfs_levinfo_init( masxfs_levinfo_t * pi, const char *name, masxfs_entry_type_t d_type, ino_t d_inode );
void masxfs_levinfo_n_init( masxfs_levinfo_t * li, const char *name, size_t len, masxfs_entry_type_t d_type, ino_t d_inode );
