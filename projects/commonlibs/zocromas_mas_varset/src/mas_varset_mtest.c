  ...
  for ( int iter = 0; iter < 1; iter++ )
  {
    ...
    if ( 1 )
    {
      if ( 1 )
      {
        ...
        /* mas_varvec_variable_set_element( vc->vec, 0, "\r\n", 2, "HTTP 7.0" ); */
      }
...
test50( void )
{
  ...
  {
    mas_varvec_element_t *v1, *v2, *v3, *v4;
