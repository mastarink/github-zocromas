...
mas_vclass_element_t *_mas_varset_vclass_add_tail( mas_varset_class_t * vclass, const char *tail );
...
mas_vclass_element_t *_mas_varset_vclass_search_variable( mas_varset_class_t * vclass, const char *name );
...
mas_vclass_element_t *mas_varset_vclass_set_element( mas_varset_class_t * vclass, const char *str, size_t offset, const char *suffix,
                                                     size_t suffix_len );

void mas_varset_vclass_variable_set_element( mas_vclass_element_t * var, const char *str, size_t offset, const char *suffix,
                                             size_t suffix_len );
