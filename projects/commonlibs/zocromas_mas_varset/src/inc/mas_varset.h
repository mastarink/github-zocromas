...
void _mas_varset_set_head( mas_varset_t * varset, const char *vclass_name, const char *head );
void _mas_varset_add_tail( mas_varset_t * varset, const char *vclass_name, const char *head );
