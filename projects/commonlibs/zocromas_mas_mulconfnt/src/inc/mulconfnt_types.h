...
typedef char *( *source_load_string_fun_t ) ( config_source_desc_t * descr, int pos );
typedef mas_argvc_t( *source_load_targ_fun_t ) ( config_source_desc_t * descr, mas_argvc_t targ, int pos );
