...
int masxfs_levinfo_open( masxfs_levinfo_t * li, masxfs_scan_mode_t mode );
int masxfs_levinfo_close( masxfs_levinfo_t * li, masxfs_scan_mode_t mode );
...
int masxfs_levinfo_close_all_up( masxfs_levinfo_t * li, masxfs_scan_mode_t mode );

int masxfs_levinfo_stat( masxfs_levinfo_t * li, masxfs_scan_mode_t mode );
