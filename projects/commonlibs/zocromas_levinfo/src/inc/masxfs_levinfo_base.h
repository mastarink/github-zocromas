...
void masxfs_levinfo_init( masxfs_levinfo_t * pi, masxfs_depth_t lidepth, const char *name, masxfs_entry_type_t d_type, ino_t d_inode, unsigned long long node_id );
void masxfs_levinfo_n_init( masxfs_levinfo_t * li, masxfs_depth_t lidepth, const char *name, size_t len, masxfs_entry_type_t d_type, ino_t d_inode, unsigned long long node_id );
