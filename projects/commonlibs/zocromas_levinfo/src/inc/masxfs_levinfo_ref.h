...
const struct stat *masxfs_levinfo_stat_val( masxfs_levinfo_t * li, masxfs_depth_t offset );
const struct stat *masxfs_levinfo_stat_ref( masxfs_levinfo_t * li, unsigned long tflags );

size_t masxfs_levinfo_size_val( masxfs_levinfo_t * li, masxfs_depth_t offset );
size_t masxfs_levinfo_size_ref( masxfs_levinfo_t * li, unsigned long tflags );

int masxfs_levinfo_is_open( masxfs_levinfo_t * li );

int masxfs_levinfo_fd_val( masxfs_levinfo_t * li, masxfs_depth_t offset );
int masxfs_levinfo_fd_ref( masxfs_levinfo_t * li, unsigned long tflags );

masxfs_dir_t *masxfs_levinfo_pdir_val( masxfs_levinfo_t * li, masxfs_depth_t offset );
masxfs_dirent_t *masxfs_levinfo_pde_val( masxfs_levinfo_t * li, masxfs_depth_t offset );
...
const char *masxfs_levinfo_name_val( masxfs_levinfo_t * li, masxfs_depth_t offset );
