...
int masxfs_levinfo_fs_open( masxfs_levinfo_t * li, masxfs_levinfo_flags_t flags );
int masxfs_levinfo_fs_close( masxfs_levinfo_t * li );

int masxfs_levinfo_fs_stat( masxfs_levinfo_t * li, masxfs_levinfo_flags_t flags );
