...
{
  MASXFS_CB_OFF_NAME = 1L << MASXFS_CB_OFF_NAME_NUM,
  MASXFS_CB_PATH = 1L << MASXFS_CB_PATH_NUM,
  MASXFS_CB_STAT = 1L << MASXFS_CB_STAT_NUM,
  MASXFS_CB_NO_FD = 1L << MASXFS_CB_NO_FD_NUM,
  ...
  MASXFS_CB_SINGLE_CB = 1L << MASXFS_CB_SINGLE_CB_NUM,
  MASXFS_CB_SKIP = 1L << MASXFS_CB_SKIP_NUM,
  MASXFS_CB_MODE_FS = 1L << MASXFS_CB_MODE_FS_NUM,
  MASXFS_CB_MODE_DB = 1L << MASXFS_CB_MODE_DB_NUM,
  MASXFS_CB_UP_ROOT = 1L << MASXFS_CB_UP_ROOT_NUM,
  MASXFS_CB_SELF = 1L << MASXFS_CB_SELF_NUM,
  MASXFS_CB_UP = 1L << MASXFS_CB_UP_NUM,
  MASXFS_CB_COUNT = 1L << MASXFS_CB_COUNT_NUM,
  MASXFS_CB_FROM_ROOT = 1L << MASXFS_CB_FROM_ROOT_NUM,
  MASXFS_CB_SELF_N_UP = MASXFS_CB_SELF | MASXFS_CB_UP,
  /* MASXFS_CB_CAN_UPDATE_DB = 1L << MASXFS_CB_CAN_UPDATE_DB_NUM, */
};
