...
typedef enum mas_cli_opts_e
{
  ...
  MAS_CLI_OPT_NOWOMESSAGES_PARENT,
  MAS_CLI_OPT_NOWOMESSAGES_CHILD,
  MAS_CLI_OPT_NOWOMESSAGES,
  MAS_CLI_OPT_WOMESSAGES_PARENT,
  MAS_CLI_OPT_WOMESSAGES_CHILD,
  MAS_CLI_OPT_WOMESSAGES,
